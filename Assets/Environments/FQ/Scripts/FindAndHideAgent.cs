...
public class FindAndHideAgent : Agent
{
    Rigidbody rBody;
    public Transform Target;
    public NoRBMove nrbm;
    ...
    public Vector3 normalize_pos(Vector3 v)
    {
        v.x /= 10;
        v.z /= 10;
        return v;
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        //sensor.AddObservation(normalize_pos(Target.position));
        //sensor.AddObservation(normalize_pos(this.transform.position));
        // Agent velocity
    ...
    public override void OnActionReceived(float[] vectorAction)
    {
        ...
        SetReward(-0.01f);
        //SetReward(-distanceToTarget / 100.0f);
